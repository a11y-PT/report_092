---
website: "Serviços de Ação Social do Instituto Politécnico de Viana do Castelo"          # Entre as aspas escreve o nome do website
date: "31/12/1999"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://sasocial.sas.ipvc.pt/"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://sasocial.sas.ipvc.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
